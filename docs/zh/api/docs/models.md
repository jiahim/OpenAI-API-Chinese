...
> 完整文档索引请参阅 [llms.txt](/llms.txt)。在页面 URL 后追加 `.md` 即可获得文档页面的 Markdown 版本。

> 探索 OpenAI API 上可用的模型。

如果你不确定从何开始，可以使用 [GPT-6 Astra](/api/docs/models/gpt-6-astra)，这是我们用于复杂推理和编码的旗舰模型。选择 [GPT-5.6 Terra](/api/docs/models/gpt-5.6-terra) 以平衡智能与成本，或选择 [GPT-5.6 Luna](/api/docs/models/gpt-5.6-luna) 用于对成本敏感的高吞吐量工作负载。
...
- [GPT-6 Astra](/api/docs/models/gpt-6-astra.md)：从这里开始应对复杂推理和编码任务。
- [GPT-5.6 Terra](/api/docs/models/gpt-5.6-terra.md)：在智能与成本之间取得平衡。
- [GPT-5.6 Luna](/api/docs/models/gpt-5.6-luna.md)：针对成本敏感的高吞吐量工作负载进行优化。
...
- [babbage-002](/api/docs/models/babbage-002.md): 替代 GPT-3 ada 和 babbage 基础模型的版本
...
- [chatgpt-image-latest](/api/docs/models/chatgpt-image-latest.md): ChatGPT 之前使用的图像模型。
...
- [Daybreak Blue](/api/docs/models/gpt-daybreak-blue-latest.md): 用于防御性网络安全工作的旗舰通用模型别名，并附带安全防护措施。
- [Daybreak Red](/api/docs/models/gpt-daybreak-red-latest.md): 用于经授权的漏洞研究和安全测试的高级网络安全模型别名。
- [GPT-3.5 Turbo](/api/docs/models/gpt-3.5-turbo.md): 用于低成本聊天和非聊天任务的旧版 GPT 模型
- [GPT-4](/api/docs/models/gpt-4.md)：一款早期的高智能 GPT 模型
- [GPT-4 Turbo](/api/docs/models/gpt-4-turbo.md)：一款早期的高智能 GPT 模型
- [GPT-4 Turbo Preview](/api/docs/models/gpt-4-turbo-preview.md)：一款早期的高速 GPT 模型
...
- [GPT-4o Mini](/api/docs/models/gpt-4o-mini.md)：面向专注任务的快速、经济的小型模型
- [GPT-4o Mini Audio](/api/docs/models/gpt-4o-mini-audio-preview.md): 较小的模型，支持音频输入与输出
- [GPT-4o Mini Realtime](/api/docs/models/gpt-4o-mini-realtime-preview.md): 较小的实时模型，支持文本和音频输入与输出
...
- [GPT-5](/api/docs/models/gpt-5.md): 用于编码和智能体任务的前代智能推理模型，支持可配置的推理力度
- [GPT-5 Chat](/api/docs/models/gpt-5-chat-latest.md): GPT-5 model used in ChatGPT
- [GPT-5 Mini](/api/docs/models/gpt-5-mini.md): 为成本敏感、低延迟、高吞吐量工作负载提供强大智能
- [GPT-5 nano](/api/docs/models/gpt-5-nano.md): GPT-5 中最快、成本效益最高的版本
...
- [GPT-5.1](/api/docs/models/gpt-5.1.md): 适用于编码和智能体任务的最佳模型，具有可配置的推理强度
...
- [GPT-5.2](/api/docs/models/gpt-5.2.md): 上一代旗舰模型，适用于专业工作，支持可配置的推理强度
- [GPT-5.2 Chat](/api/docs/models/gpt-5.2-chat-latest.md): 在 ChatGPT 中使用的 GPT-5.2 模型
- [GPT-5.2 Pro](/api/docs/models/gpt-5.2-pro.md): 上一代专业版模型，用于专业工作，可生成更智能、更精确的回复。
- [GPT-5.2-Codex](/api/docs/models/gpt-5.2-codex.md): 我们最智能的编码模型，专为长时程、智能体编码任务而优化。
...
- [GPT-5.5 Pro](/api/docs/models/gpt-5.5-pro.md)：GPT-5.5 的版本，可生成更智能、更精确的响应。
- [GPT-5.6 Cyber](/api/docs/models/gpt-5.6-cyber.md)：我们最先进的网络安全模型，用于获得授权的漏洞研究与安全测试。
...
- [GPT-6 Astra](/api/docs/models/gpt-6-astra.md)：我们最强大的模型，专为最具挑战性的端到端工作打造
- [GPT-6 Luna](/api/docs/models/gpt-6-luna.md)：我们最高效的模型，适用于聚焦且高吞吐的任务。
- [GPT-6 Sol](/api/docs/models/gpt-6-sol.md)：专为驱动复杂编码与智能体工作流而构建。
- [GPT-Audio](/api/docs/models/gpt-audio.md)：用于音频输入与输出，支持Chat Completions API
- [GPT-Audio Mini](/api/docs/models/gpt-audio-mini.md)：GPT-Audio 的高性价比版本
- [GPT-Audio-1.5](/api/docs/models/gpt-audio-1.5.md)：搭配 Chat Completions 进行音频输入与音频输出的最佳语音模型。
...
- [GPT-Image-2.5 Sunburst](/api/docs/models/gpt-image-2.5-sunburst.md): 我们用于图像生成和编辑能力最强的模型
- [GPT-Live 1](/api/docs/models/gpt-live-1.md): 我们用于自然、富有表现力的语音对话的首选模型，具备流畅的打断处理能力。
- [GPT-Live-Transcribe](/api/docs/models/gpt-live-transcribe.md): 用于实时转写的低延迟语音转文本模型
...
- [GPT-Realtime-1.5](/api/docs/models/gpt-realtime-1.5.md)：面向音频输入、音频输出的最佳语音模型
...
- [o1-pro](/api/docs/models/o1-pro.md): 拥有更多算力的 o1 版本，可提供更优质的回复
- [o3](/api/docs/models/o3.md): 用于复杂任务的推理模型，已由 GPT-5 继任
- [o3-deep-research](/api/docs/models/o3-deep-research.md): 我们最强大的深度研究模型
- [o3-mini](/api/docs/models/o3-mini.md): o3 的轻量替代模型
- [o3-pro](/api/docs/models/o3-pro.md): 拥有更多算力的 o3 版本，可提供更优质的回复
- [o4-mini](/api/docs/models/o4-mini.md): 快速且经济高效的推理模型，已由 GPT-5 Mini 继任
- [o4-mini-deep-research](/api/docs/models/o4-mini-deep-research.md): 更快速、更实惠的深度研究模型
