...
如果你不确定从何处开始，可以使用 [GPT-6 Astra](/api/docs/models/gpt-6-astra)，这是我们用于复杂推理与编程的旗舰模型。选择 [GPT-5.6 Terra](/api/docs/models/gpt-5.6-terra) 可以在智能与成本之间取得平衡，或选择 [GPT-5.6 Luna](/api/docs/models/gpt-5.6-luna) 用于对成本敏感的高吞吐量工作负载。

所有最新的 OpenAI 模型均支持文本与图像输入、文本输出、多语言能力以及视觉理解。可通过 [Responses API](/api/reference/resources/responses/methods/create) 和我们的 [客户端 SDK](/api/docs/libraries).

## 精选模型

- [GPT-6 Astra](/api/docs/models/gpt-6-astra.md): 我们能力最强的模型，专为最困难的端到端任务而构建
...
- [babbage-002](/api/docs/models/babbage-002.md): 替代 GPT-3 ada 和 babbage 基础模型
...
- [davinci-002](/api/docs/models/davinci-002.md): 替代 GPT-3 curie 和 davinci 基础模型
- [Daybreak Blue](/api/docs/models/gpt-daybreak-blue-latest.md): 旗舰通用模型的别名，包含用于防御性网络安全工作的安全措施。
- [Daybreak Red](/api/docs/models/gpt-daybreak-red-latest.md): 面向已授权漏洞研究和安全测试的高级网络安全模型的别名。
- [GPT-3.5 Turbo](/api/docs/models/gpt-3.5-turbo.md): 用于较低成本聊天和非聊天任务的旧版 GPT 模型
...
- [GPT-4.1 nano](/api/docs/models/gpt-4.1-nano.md)：最快且最具成本效益的 GPT-4.1 版本
...
- [GPT-4o Mini](/api/docs/models/gpt-4o-mini.md)：快速、经济的小型模型，适用于聚焦任务
- [GPT-4o Mini Audio](/api/docs/models/gpt-4o-mini-audio-preview.md): 可处理音频输入和输出的较小模型
...
- [GPT-4o Realtime](/api/docs/models/gpt-4o-realtime-preview.md): 可处理实时文本和音频输入输出的模型
...
- [GPT-4o Transcribe Diarize](/api/docs/models/gpt-4o-transcribe-diarize.md): 可识别说话人身份及其发言时段的转录模型
...
- [GPT-5 nano](/api/docs/models/gpt-5-nano.md): 最快速且性价比最高的 GPT-5 版本
- [GPT-5 Pro](/api/docs/models/gpt-5-pro.md): 智能程度更高、回答更精确的 GPT-5 版本
- [GPT-5-Codex](/api/docs/models/gpt-5-codex.md): 为 Codex 中的智能体编程优化的 GPT-5 版本
- [GPT-5.1](/api/docs/models/gpt-5.1.md): 适用于编程和智能体任务的最佳模型，支持可配置的推理强度
...
- [GPT-5.1-Codex Mini](/api/docs/models/gpt-5.1-codex-mini.md): 更小、更具性价比且能力较弱的 GPT-5.1-Codex 版本
...
- [GPT-5.2 Pro](/api/docs/models/gpt-5.2-pro.md): 面向专业工作的前代 pro 模型，能够生成更智能、更精确的回复。
- [GPT-5.2-Codex](/api/docs/models/gpt-5.2-codex.md): 我们最智能的编程模型，专为长时程智能体编码任务而优化。
...
- [GPT-5.4 nano](/api/docs/models/gpt-5.4-nano.md): 我们最便宜的 GPT-5.4 系列模型，适用于简单的大规模任务
- [GPT-5.4 Pro](/api/docs/models/gpt-5.4-pro.md): GPT-5.4 的版本，能够生成更智能、更精确的回复。
- [GPT-5.5](/api/docs/models/gpt-5.5.md): 面向编码与专业工作的全新智能等级。
...
- [GPT-Audio-1.5](/api/docs/models/gpt-audio-1.5.md): 通过 Chat Completions 进行音频输入与音频输出的最佳语音模型。
...
- [GPT-Image-2.5 Sunburst](/api/docs/models/gpt-image-2.5-sunburst.md)：我们用于图像生成和编辑的最强模型
- [GPT-Live-Transcribe](/api/docs/models/gpt-live-transcribe.md)：用于实时转写的低延迟语音转文本模型
- [gpt-oss-120b](/api/docs/models/gpt-oss-120b.md)：最强大的开放权重模型，可适配单张 H100 GPU
- [gpt-oss-20b](/api/docs/models/gpt-oss-20b.md)：面向低延迟的中等规模开放权重模型
- [GPT-Realtime](/api/docs/models/gpt-realtime.md): 可处理实时文本和音频输入输出的模型
- [GPT-Realtime Mini](/api/docs/models/gpt-realtime-mini.md)：GPT-Realtime 的高性价比版本
- [GPT-Realtime-1.5](/api/docs/models/gpt-realtime-1.5.md)：面向音频输入与音频输出的最佳语音模型
...
- [GPT-Realtime-Translate](/api/docs/models/gpt-realtime-translate.md)：流式语音互译模型
...
- [o1-pro](/api/docs/models/o1-pro.md): 采用更多算力的 o1 版本，可提供更优响应
...
- [o3-pro](/api/docs/models/o3-pro.md): 采用更多算力的 o3 版本，可提供更优响应
...
- [TTS-1](/api/docs/models/tts-1.md): 针对速度优化的文字转语音模型
- [TTS-1 HD](/api/docs/models/tts-1-hd.md)：针对音质优化的文本转语音模型
