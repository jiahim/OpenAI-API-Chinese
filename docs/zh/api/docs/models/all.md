...
如果你不确定从哪里开始，可以选择使用 [GPT-6 Astra](/api/docs/models/gpt-6-astra)，这是我们用于复杂推理和编码的旗舰模型。选择 [GPT-5.6 Terra](/api/docs/models/gpt-5.6-terra) 来平衡智能与成本，或选择 [GPT-5.6 Luna](/api/docs/models/gpt-5.6-luna) 用于成本敏感、高吞吐量的工作负载。

所有最新的 OpenAI 模型都支持文本和图像输入、文本输出、多语言能力和视觉能力。这些模型可通过 [Responses API](/api/reference/resources/responses/methods/create) 以及我们的 [客户端 SDK](/api/docs/libraries).

## Featured models

- [GPT-6 Astra](/api/docs/models/gpt-6-astra.md): 我们最强大的模型，专为最困难的端到端任务打造
...
- [Daybreak Blue](/api/docs/models/gpt-daybreak-blue-latest.md): 用于防御性网络安全工作的旗舰通用模型别名。
- [Daybreak Red](/api/docs/models/gpt-daybreak-red-latest.md): 用于已授权漏洞研究与安全测试的高级网络安全模型别名。
- [GPT-3.5 Turbo](/api/docs/models/gpt-3.5-turbo.md): 用于更经济的聊天和非聊天任务的旧版 GPT 模型
- [GPT-4](/api/docs/models/gpt-4.md): 旧版高智能 GPT 模型
- [GPT-4 Turbo](/api/docs/models/gpt-4-turbo.md): 旧版高智能 GPT 模型
- [GPT-4 Turbo Preview](/api/docs/models/gpt-4-turbo-preview.md): 旧版快速 GPT 模型
- [GPT-4.1](/api/docs/models/gpt-4.1.md): 最强的非推理模型
...
- [GPT-4o Mini](/api/docs/models/gpt-4o-mini.md): 快速、经济的紧凑型模型，适合处理针对性任务
...
- [GPT-4o Mini Search Preview](/api/docs/models/gpt-4o-mini-search-preview.md): 快速、经济的小型模型，适用于网页搜索
...
- [GPT-5](/api/docs/models/gpt-5.md): 用于编码和智能体任务的上一代智能推理模型，推理力度可配置
- [GPT-5 Chat](/api/docs/models/gpt-5-chat-latest.md): 在 ChatGPT 中使用的 GPT-5 模型
- [GPT-5 Mini](/api/docs/models/gpt-5-mini.md): 面向成本敏感、低延迟、高吞吐量工作负载的强力智能
...
- [GPT-5-Codex](/api/docs/models/gpt-5-codex.md): 在 Codex 中针对智能体编码优化的 GPT-5 版本
- [GPT-5.1](/api/docs/models/gpt-5.1.md): 适用于编码和智能体任务、可配置推理强度的最佳模型
- [GPT-5.1 Chat](/api/docs/models/gpt-5.1-chat-latest.md): 在 ChatGPT 中使用的 GPT-5.1 模型
- [GPT-5.1-Codex](/api/docs/models/gpt-5.1-codex.md): 在 Codex 中针对智能体编码优化的 GPT-5.1 版本。
...
- [GPT-5.2](/api/docs/models/gpt-5.2.md): 面向专业工作的上一代旗舰模型，可配置推理强度
- [GPT-5.2 Chat](/api/docs/models/gpt-5.2-chat-latest.md): ChatGPT 中使用的 GPT-5.2 模型
- [GPT-5.2 Pro](/api/docs/models/gpt-5.2-pro.md): 面向专业工作的上一代 pro 模型，能够产生更智能、更精确的回复。
- [GPT-5.2-Codex](/api/docs/models/gpt-5.2-codex.md): 我们最智能的编码模型，专为长时程、智能体编码任务优化。
...
- [GPT-5.4](/api/docs/models/gpt-5.4.md): 面向编码和专业工作的更具性价比的模型。
...
- [GPT-5.5](/api/docs/models/gpt-5.5.md): 面向编码与专业工作的新一代智能能力。
...
- [GPT-Live 1](/api/docs/models/gpt-live-1.md)：我们顶级的语音对话模型，可提供自然且富有表现力的对话体验，并能顺畅处理打断。
- [GPT-Live-Transcribe](/api/docs/models/gpt-live-transcribe.md)：用于实时转写的低延迟语音转文本模型
- [gpt-oss-120b](/api/docs/models/gpt-oss-120b.md)：能力最强的开放权重模型，可放入单张 H100 GPU
...
- [GPT-Realtime-2](/api/docs/models/gpt-realtime-2.md)：具备工具调用能力的推理模型
- [GPT-Realtime-2.1](/api/docs/models/gpt-realtime-2.1.md)：具备工具调用能力的推理模型
- [GPT-Realtime-2.1 Mini](/api/docs/models/gpt-realtime-2.1-mini.md)：具备工具调用能力的推理模型
...
- [o1-pro](/api/docs/models/o1-pro.md): 通过更多算力提升响应质量的 o1 版本
- [o3](/api/docs/models/o3.md): 适用于复杂任务的推理模型，已由 GPT-5 接替
- [o3-deep-research](/api/docs/models/o3-deep-research.md): 我们最强大的深度研究模型
- [o3-mini](/api/docs/models/o3-mini.md): o3 的小型替代模型
- [o3-pro](/api/docs/models/o3-pro.md): 算力更强的 o3 版本，可提供更优质的响应
...
- [Sora 2](/api/docs/models/sora-2.md): 支持音画同步的旗舰视频生成模型
- [Sora 2 Pro](/api/docs/models/sora-2-pro.md): 最先进的音画同步视频生成模型
...
- [GPT-Rosalind](/api/docs/pricing#specialized-models): 面向已获批机构的生命科学推理。模型 ID： `gpt-rosalind-research`.
